...
namespace BeatSurgeon
{
    ...
    public class PluginConfig
    {
        ...
        public virtual void CopyFrom(PluginConfig other)
        {
            ...
            DisableOnRanked = other.DisableOnRanked;
            NotifyOnRankedDisable = other.NotifyOnRankedDisable;
            DisableOnRankedSS = other.DisableOnRankedSS;
            DisableOnRankedBL = other.DisableOnRankedBL;
            DisableOnRankedAccSaber = other.DisableOnRankedAccSaber;
